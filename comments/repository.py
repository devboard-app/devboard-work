...
async def create_comment(ticket: Ticket, author_id: str, body: str, attachment_ids: list) -> Comment:
    return await Comment.objects.acreate(ticket=ticket, author_id=author_id, body=body, attachment_ids=attachment_ids)
